 class ClientCasesController < ApplicationController
  ...
  private
    ...
    def client_case_params
      params.require(:client_case).permit(:name, :client_id, :case_number, :case_type_id, :court_hall, :court_complex_id, :case_year, :advocate_id, :file_no, :state_id, :district_id, :case_status, :nature_of_case)
    end
end
